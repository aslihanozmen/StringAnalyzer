...
object StringSolver {
  ...
  type S = String
  case class Input_state(inputs: Seq[String], position: Int)


  def create( javalist: java.util.List[String], position: Int):Input_state= {
    Input_state(javalist.asScala, position)
  }
